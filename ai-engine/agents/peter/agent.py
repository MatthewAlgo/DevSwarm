...
from agents.peter.prompts import PROMPT

logger = logging.getLogger("devswarm.agents.peter")
...
class PeterAgent(BaseAgent):
    ...
    default_room = "Desks"
    output_schema = PeterDesignOutput
    ...
    async def execute(
        self,
        state: OfficeState,
        parsed: PeterDesignOutput,
        context: AgentContext,
    ) -> OfficeState:
        """Share design output with Dan and Marco."""
        ...
        # Send to Dan for content integration
